...
class AnalyzePostView(APIView): 
    def get(self, request, pk):
        ...
        query = (
            ...
            "그 다음 무조건 심리 분석 결과에 따라 꼭 [행복: , 슬픔: , 분노: , 불안: ]이 형식으로 4가지의 퍼센트를 도출해주세요. 다른 감정은 필요없고 4가지 감정은 꼭 포함되어야합니다. 심리분석에 나타나지 않은 감정은 0%라고 분석해도 괜찮습니다. 이때 각 퍼센트는 합해서 100%가 되어야 합니다."
            "감정에 따라서 아래의 전시회 데이터 중 적절한 전시회를 추천해주세요."
            "필수로 이 세가지 형식을 맞춰서 꼭 800자에서 1000자 사이로 작성해주세요."
        )

    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ImageField(blank=True, default='default_profile.png', null=True, upload_to='accounts_photo', verbose_name='프로필')),
                ('username', models.CharField(max_length=40, unique=True, verbose_name='아이디')),
                ('name', models.CharField(max_length=40, verbose_name='이름')),
                ('nickname', models.CharField(error_messages={'max_length': '닉네임은 8자 이내로 설정해주세요.', 'unique': '이미 사용중인 닉네임입니다.'}, max_length=8, unique=True, verbose_name='닉네임')),

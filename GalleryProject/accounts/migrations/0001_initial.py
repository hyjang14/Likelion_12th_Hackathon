    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ImageField(blank=True, default='accounts_photo/accounts_Default.jpg', null=True, upload_to='accounts_photo', verbose_name='프로필')),
                ('username', models.CharField(max_length=40, unique=True, verbose_name='아이디')),
                ('name', models.CharField(max_length=40, verbose_name='이름')),
                ('nickname', models.CharField(max_length=40, unique=True, verbose_name='닉네임')),
